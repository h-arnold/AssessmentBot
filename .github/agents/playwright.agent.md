---
name: 'Playwright'
description: 'Creates, runs and debugs Playwright E2E tests'
user-invocable: true
tools: [read/readFile, bash, grep, web_search, web_fetch, write_file, edit, todo]
---
...
For multi-open tests, multiply: 2 opens × 2 replays = 4 entries.
