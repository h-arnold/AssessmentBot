 ...
 * script implementation so the `WizardStepper` class is available:
 *   - `src/AdminSheet/UI/partials/Stepper.html` (markup partial)
 *   - `src/AdminSheet/UI/partials/StepperJS.html` (client-side script exposing `WizardStepper`)
