...
class AnalysisSheetManager extends BaseSheetManager {
    ...
    createHeadersRequests() {
      ...
      this.requests.push(this.createHeaderFormattingRequest(sheetId, this.headers.topHeaders.length, 0, 0, {
        wordWrap: true,
      ...
      this.requests.push(this.createHeaderFormattingRequest(sheetId, this.headers.subHeaders.length, 1, 1, {
        wordWrap: false,
