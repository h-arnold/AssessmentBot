...
| Doc                                                          | Summary                                                     |
| ------------------------------------------------------------ | ----------------------------------------------------------- |
| `docs/developer/builder/builder-script.md`                   | Builder pipeline stages, error model, diagnostics           |
| `docs/developer/builder/TypeScriptAndLintConfigHierarchy.md` | TypeScript/ESLint config hierarchy and shared-vs-leaf rules |
| `docs/developer/builder/regression-checker-how-to.md`        | Regression checker CLI configuration and usage              |
...
## 4. Contractual Inputs and Outputs
...
## 7. HtmlService and Global-Symbol Constraints
