...
| **Frontend Data Analysis Response** | [`frontend-data-analysis-response.md`](frontend-data-analysis-response.md) | None — derived frontend validation contract                        | None — in-memory `DataAnalysisService` output                                                                                                                                                                                            | AverageContribution, MetricResult, per-task/heatmap projections                                                               |
...
- **Frontend Data Analysis Response** is derived in memory from ABClass data and live
  AssignmentDefinition partials; it has no persistence or transport boundary.
