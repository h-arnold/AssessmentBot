...
The goal of Assessment Bot is very simple: to **inform** teacher judgement. It doesn't feed any information back to the students as that is for you, the teacher, to determine the best way to deliver that feedback.
...
Here's a really simple example to illustrate the point. Imagine that you've got a piece of work and you're only assessing for spelling punctuation and grammar. You have the following students:
