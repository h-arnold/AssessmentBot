...
- [docs/developer/backend/AssessmentFlow.md](docs/developer/backend/AssessmentFlow.md) — described the definition lifecycle and the rationale for the freshness re-check.
